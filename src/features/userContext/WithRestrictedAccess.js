...
import { selectIsAuthenticated, selectCurrentUserHasPermissions } from './userContext.selectors';

const WithRestrictedAccess = (WrappedComponent, requiredPermissions = []) => {
    const ProtectedRoute = () => {
        const isAuthenticated = !!useSelector(selectIsAuthenticated);
        const hasPermissions = useSelector(selectCurrentUserHasPermissions(requiredPermissions));
